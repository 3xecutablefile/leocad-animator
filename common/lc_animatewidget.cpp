...
// Used by WalkCycleClicked: after procedurally regenerating State.Frames, mirror it into
// State.Keyframes (one keyframe per frame, Linear easing) so Constant Keyframe mode's later
